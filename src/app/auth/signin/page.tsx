        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <button 
              ...
              className="w-full bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 rounded-xl p-4 flex items-center justify-center gap-3"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-950 text-slate-400">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-600 bg-transparent text-[#f59794] focus:ring-[#f59794]" />
                <span className="ml-2 text-sm text-slate-400">Remember me</span>
              </label>
              <Link href="#" className="text-sm text-[#f59794] hover:text-[#ff8a87] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-slate-400 mt-6">
            ...
            <Link href="/auth/signup" className="text-[#f59794] hover:text-[#ff8a87] font-medium ml-1 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
